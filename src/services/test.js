...
async function prueba() {
  const ejemplo = {
    ...
    documento: "CC 12345678", // ===== 🔹 NUEVO: Método de pago (todo parametrizable) =====
    pago: {
      metodo: "aplazado", // "unico" | "aplazado"
      cuota_inicial: 1_350_000, // se mostrará como $ 1.350.000
      numero_cuotas: 24,
      valor_cuota: 131_250, // $ 131.250
      valor_pagado_a_la_fecha: 2_000_000,
      fase_higienica_incluida: true, // pinta [x] Sí  [ ] No en una sola línea
    },

    // ===== 🔹 NUEVO: Observaciones por fase (se imprimen bajo cada FASE) =====
    // Puedes usar objeto { "1": "...", "2": "..."} o array ["", "obsF1", "obsF2", ...]
    observaciones_fases: {
    ...
    // ===== 🔹 NUEVO: Fecha de aprobación del paciente (zona de firmas) =====
    firma_paciente_fecha: "2025-08-13",
